...
@WebServlet("/book")
public class bookk extends HttpServlet {
	static int cost=0;
	protected void doPost(HttpServletRequest request,
        ...
        try
        {
          ...
          String query = " select movieId, screen, slot, booked from shows where id="+showId;
          System.out.println(showId);
          ResultSet rs = null, rs2=null;
          int screen=0, slot=0, booked=0, movieId=0;
          ...
          query = " select * from moviedatabase where id="+movieId;
          rs = stmt.executeQuery(query);
         ...
         String htmlResponse2;
          ...
          switch(screen){
          	case 1: if(slot==1)
          			{
          			showS1T1 m = new showS1T1(name, genre, duration, director);
          			m.booked=booked;
          			if(!m.bookNew(number)){
  	          	...
  	          	preparedStmt.execute();
          				...
          				showS1T2 m=new showS1T2(name, genre, duration, director);
          				m.booked=booked;
          				if(!m.bookNew(number)){
              				htmlRespone += "<center><h2>Show Full</h2><br/></center>"; 
              			}
      	          	...
      	          	System.out.println(query);
          				...
          				showS1T3 m=new showS1T3(name, genre, duration, director);
          				m.booked=booked;
          				if(!m.bookNew(number)){
              				htmlRespone += "<center><h2>Show Full</h2><br/></center>"; 
              			}
          	...
          	case 2: if(slot==1){
          		showS2T1 m=new showS2T1(name, genre, duration, director);
          		m.booked=booked;
          		if(!m.bookNew(number)){
      				htmlRespone += "<center><h2>Show Full</h2><br/></center>"; 
      			}
      				...
      				htmlRespone += "<center><div style='border:1px solid black; border-radius:3px; width:400px;'><h2>Tickets Booked</h2><hr><br/><h3>Please pay Rs." + cost + "</h3><br><hr><p>order: "+ number+" x " +clss+" tickets<br>Movie: "+name+"- ("+duration+" minutes)</p><h2>Screen: "+screen+"</h2><br><h2>Slot: "+slot+"</h2></div></center>"; 
  						...
  						showS2T2 m=new showS2T2(name, genre, duration, director);
  						m.booked=booked;
  						if(!m.bookNew(number)){
  	          				htmlRespone += "<center><h2>Show Full</h2><br/></center>"; 
  	          			}
  						...
  						showS2T3 m=new showS2T3(name, genre, duration, director);
  						m.booked=booked;
  						if(!m.bookNew(number)){
  	          				htmlRespone += "<center><h2>Show Full</h2><br/></center>"; 
  	          			}
          	...
          	case 3: if(slot==1){
          		showS3T1 m=new showS3T1(name, genre, duration, director);
          		m.booked=booked;
          		if(!m.bookNew(number)){
      				htmlRespone += "<center><h2>Show Full</h2><br/></center>"; 
      			}
      				...
      				htmlRespone += "<center><div style='border:1px solid black; border-radius:3px; width:400px;'><h2>Tickets Booked</h2><hr><br/><h3>Please pay Rs." + cost + "</h3><br><hr><p>order: "+ number+" x " +clss+" tickets<br>Movie: "+name+"- ("+duration+" minutes)</p><h2>Screen: "+screen+"</h2><br><h2>Slot: "+slot+"</h2></div></center>"; 
  						...
  						showS3T2 m=new showS3T2(name, genre, duration, director);
  						m.booked=booked;
  						if(!m.bookNew(number)){
  	          				htmlRespone += "<center><h2>Show Full</h2><br/></center>"; 
  	          			}
  						...
  						showS3T3 m=new showS3T3(name, genre, duration, director);
  						m.booked=booked;
  						if(!m.bookNew(number)){
  	          				htmlRespone += "<center><h2>Show Full</h2><br/></center>"; 
  	          			}
